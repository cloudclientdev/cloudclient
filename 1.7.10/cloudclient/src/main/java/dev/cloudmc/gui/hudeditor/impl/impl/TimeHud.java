        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - (Cloud.INSTANCE.fontHelper.size20.getStringWidth(TimeHelper.getFormattedTimeSecond())) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Cloud.INSTANCE.mc.fontRendererObj.drawString(
                        TimeHelper.getFormattedTimeSecond(),
                        getX() + getW() / 2 - (Cloud.INSTANCE.mc.fontRendererObj.getStringWidth(TimeHelper.getFormattedTimeSecond())) / 2,
                        getY() + 6, getColor()
                );
            }
