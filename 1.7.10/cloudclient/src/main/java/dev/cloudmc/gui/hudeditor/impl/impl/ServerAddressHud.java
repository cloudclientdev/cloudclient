        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.fontHelper.size20.drawString(
                        Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : "",
                        getX() + getW() / 2f - (Cloud.INSTANCE.fontHelper.size20.getStringWidth(Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : "")) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Cloud.INSTANCE.mc.fontRendererObj.drawString(
                        Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : "",
                        getX() + getW() / 2 - (Cloud.INSTANCE.mc.fontRendererObj.getStringWidth(Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : "")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
