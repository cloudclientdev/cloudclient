    ...
    public void renderMod(int mouseX, int mouseY) {
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.mc.fontRenderer.drawString("X: " + MathHelper.round(Cloud.INSTANCE.mc.thePlayer.posX, 1), getX() + 5, getY() + 5, getColor());
                Cloud.INSTANCE.mc.fontRenderer.drawString("Y: " + MathHelper.round(Cloud.INSTANCE.mc.thePlayer.posY, 1), getX() + 5, getY() + 5 + 14, getColor());
                Cloud.INSTANCE.mc.fontRenderer.drawString("Z: " + MathHelper.round(Cloud.INSTANCE.mc.thePlayer.posZ, 1), getX() + 5, getY() + 5 + 28, getColor());
