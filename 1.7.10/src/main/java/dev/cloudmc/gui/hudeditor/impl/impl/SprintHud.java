        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2 - Cloud.INSTANCE.fontHelper.size20.getStringWidth("Sprint: " + (isSprinting() ? "Toggled" : "Vanilla")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
                ...
                Cloud.INSTANCE.mc.fontRenderer.drawString(
                        "Sprint: " + (isSprinting() ? "Toggled" : "Vanilla"),
                        getX() + getW() / 2 - Cloud.INSTANCE.mc.fontRenderer.getStringWidth("Sprint: " + (isSprinting() ? "Toggled" : "Vanilla")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
