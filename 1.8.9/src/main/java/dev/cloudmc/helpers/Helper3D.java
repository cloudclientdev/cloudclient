...
public class Helper3D {
    ...
    public static double calculateCameraDistance(double d0, double d1, double d2, double d3) {
        ...
        double d4 = (double) (net.minecraft.util.MathHelper.sin(f1 / 180.0F * (float) Math.PI) * net.minecraft.util.MathHelper.cos(f2 / 180.0F * (float) Math.PI)) * d3;
        double d5 = (double) (-net.minecraft.util.MathHelper.cos(f1 / 180.0F * (float) Math.PI) * net.minecraft.util.MathHelper.cos(f2 / 180.0F * (float) Math.PI)) * d3;
