        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.fontHelper.size20.drawString(
                        ...
                        getX() + getW() / 2f - Cloud.INSTANCE.fontHelper.size20.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Cloud.INSTANCE.mc.fontRenderer.drawString(
                        "Sneak: " + (isSneaking() ? "Toggled" : "Vanilla"),
                        getX() + getW() / 2 - Cloud.INSTANCE.mc.fontRenderer.getStringWidth("Sneak: " + (isSneaking() ? "Toggled" : "Vanilla")) / 2,
                        getY() + 6,
                        getColor()
                );
            }
