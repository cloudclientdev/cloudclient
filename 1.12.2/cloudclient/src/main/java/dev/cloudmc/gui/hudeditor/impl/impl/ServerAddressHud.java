        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.mc.fontRenderer.drawString(
                        Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : Cloud.INSTANCE.mc.getCurrentServerData().serverIP,
                        getX() + getW() / 2 - (Cloud.INSTANCE.mc.fontRenderer.getStringWidth(Cloud.INSTANCE.mc.isIntegratedServerRunning() ? "Singleplayer" : Cloud.INSTANCE.mc.getCurrentServerData().serverIP)) / 2,
                        getY() + 6,
                        getColor()
                );
            }
