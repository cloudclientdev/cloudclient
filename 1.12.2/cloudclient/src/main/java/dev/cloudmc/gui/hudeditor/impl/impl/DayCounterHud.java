...
public class DayCounterHud extends HudMod {
        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                Cloud.INSTANCE.fontHelper.size20.drawString(
                        "Day: " + getDay(),
                        getX() + getW() / 2f - Cloud.INSTANCE.fontHelper.size20.getStringWidth("Day: " + getDay()) / 2f,
                        getY() + 6,
                        getColor()
                );
            } else {
                ...
                Cloud.INSTANCE.mc.fontRenderer.drawString(
                        "Day: " + getDay(),
                        getX() + getW() / 2 - Cloud.INSTANCE.mc.fontRenderer.getStringWidth("Day: " + getDay()) / 2,
                        getY() + 6,
                        getColor()
                );
            }
    ...
    private long getDay() {
        return Cloud.INSTANCE.mc.world.getWorldTime() / 24000L;
    }
}
