    ...
    public void renderMod(int mouseX, int mouseY) {
        ...
        if (Cloud.INSTANCE.modManager.getMod(getName()).isToggled()) {
            if (isModern()) {
                ...
                int value = (int) normalized(Cloud.INSTANCE.mc.player.rotationYaw);
                ...
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Cloud.INSTANCE.mc.player.rotationYaw) + i * 90) % 360 + getX() - 86);
                    int xHalf = (int) ((normalized(Cloud.INSTANCE.mc.player.rotationYaw) + i * 90) % 360 + getX() - 43);
                ...
                FontRenderer fontHelper = Cloud.INSTANCE.mc.fontRenderer;
                ...
                GLHelper.startScissor(getX(), getY(), (int) (getW() * getSize()), (int) (getH() * getSize()));
                for (int i = 0; i < 4; i++) {
                    int xFull = (int) ((normalized(Cloud.INSTANCE.mc.player.rotationYaw) + i * 90) % 360 + getX() - 83);
                    int xHalf = (int) ((normalized(Cloud.INSTANCE.mc.player.rotationYaw) + i * 90) % 360 + getX() - 40);
